...
import com.wysiwyg.temanolga.ui.addevent.PlaceSearchActivity
import com.wysiwyg.temanolga.data.model.Event
import com.wysiwyg.temanolga.utilities.DateTimePicker
import com.wysiwyg.temanolga.utilities.ValidateUtil
...
class EditEventActivity : AppCompatActivity(), EditEventView {
    ...
    override fun showSuccessUpdate() {
        toast(getString(R.string.event_updated)).show()
        finish()
    }

    override fun showFailedUpdate() {
        toast(getString(R.string.event_update_fail)).show()
    }

    override fun showNoConnection() {
        snackbar(et_desc, getString(R.string.network_edit_event)).show()
    }
